...
import {FaBell, FaCaretDown, FaFacebook,FaFacebookMessenger,FaFontAwesomeFlag,FaGamepad,FaHome,FaPlus,FaSistrix,FaUser, FaVideo} from 'react-icons/fa';
    ...
    <div className='navbar'>
       ...
       <div className="navbar__middle">
          ...
          <span className='middleIcon'>
             ...
             <span className='navbar__notify'>27</span>
          </span>
          <span className='middleIcon'>
